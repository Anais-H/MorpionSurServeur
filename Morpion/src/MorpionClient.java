    ...
    public void start() {
        ...
        try {
            ...
            while (communicationEnCours) {
                ...
                } else if (messageRecu.contains("-info-")) {
                    
                    //System.out.println("Envoi d'un message à " + server_address);
                    // pourra permettre au serveur de verifier que le message a bien ete recu par le client
                    //String reponseAuto = "Bien reçu";
                    //buf = (new String(reponseAuto).getBytes());
                    //dps = new DatagramPacket(buf, buf.length, InetAddress.getByName(server_address), server_port);
                    //System.out.println("Création du Datagram et envoi ...");
